# Generated by Django 4.1.13 on 2024-04-13 13:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('professional_title', models.CharField(blank=True, max_length=140, null=True)),
                ('about', wagtail.fields.RichTextField(null=True)),
                ('thank_you_text', wagtail.fields.RichTextField(null=True)),
                ('personal_photo', models.ForeignKey(help_text='Please, upload a square photo (for example 256px x 256px).', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.image')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='skilltype', to='home.homepage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('job_title', models.CharField(blank=True, default='Job Title', max_length=256)),
                ('company', models.CharField(blank=True, default=None, max_length=256)),
                ('company_url', models.URLField(blank=True, null=True)),
                ('location', models.CharField(blank=True, default=None, max_length=256)),
                ('start', models.DateField(default=django.utils.timezone.now)),
                ('end', models.DateField(blank=True, null=True)),
                ('achievement_1', models.CharField(blank=True, default=None, max_length=2000)),
                ('achievement_2', models.CharField(blank=True, default=None, max_length=2000)),
                ('achievement_3', models.CharField(blank=True, default=None, max_length=2000)),
                ('achievement_4', models.CharField(blank=True, default=None, max_length=2000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('project', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='used_technologies', to='home.project')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('experience', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='used_technologies_exp', to='home.experience')),
                ('used_technology', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.usedtechnology')),
            ],
            options={
                'ordering': ['sort_order'],
